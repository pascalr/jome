...
var bod = jome(new Screen({color: bgColor1}))
  ...
  .addChild(new Link({to: `${global._URL}/`, class: 'editor-navbtn'}, "About Jome")))
  ...
  .node()
module.exports = new HtmlPage({title: 'Jome editor', stylesheets: [`${global._URL}/reset.css`, `${global._URL}/jome-html.css`], body: bod.toString()}).toString()