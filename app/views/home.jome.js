...
module.exports = new AppPage({title: 'Simple HTML Page', content: (`<h1>Jome v-0.0.0.0.1</h1>
...
<p>Here is some code to show what Jome looks like. You can look at the <a href="${global._URL}/examples">examples</a> page to see more.</p>
...
<p>For the complete list of utils: see the <a href="${global._URL}/utils">utils page</a>.</p>
