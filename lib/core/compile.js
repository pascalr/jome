...
function compile(srcFile, options) {
  if (!srcFile.endsWith('.jome') && !srcFile.endsWith('.jomm') && !srcFile.endsWith('.jomn') && !srcFile.endsWith('.jomd')) {
    throw new Error("Can't #compile a file without .jome, .jomn, .jomd or .jomm extension.")
  }
