...
class ActionsTextSelection extends ActionView {

  render() {
    this.getRef().replaceChildren(e('div', {}, [
      e('div', {className: "panel-main-header"}, ["Text Selection"]),
  ...
  onTextSelectionChange() { this.render() }

}

export function registerActionsTextSelection(app) {
  app.registerView(new ActionsTextSelection())
}