...
const contextButtons = [
  {
    name: 'explorer',
    html: `<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-folder2-open" viewBox="0 0 16 16">
  ...
  {
    name: 'run_and_debug',
    html: `<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-bug" viewBox="0 0 16 16">
  ...
  {
    name: 'git',
    html: `<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-git" viewBox="0 0 16 16">
      <title>Git</title>
  ...
  {
    name: 'snippets',
    html: `<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-braces-asterisk" viewBox="0 0 16 16">
  ...
  {
    name: 'extensions',
    html: `<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-boxes" viewBox="0 0 16 16">
...
const bottomContextButtons = [
  {
    name: 'console',
    html: `<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-terminal" viewBox="0 0 16 16">
      <title>Console</title>
  ...
  {
    name: 'documentation',
    html: `<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-question-circle" viewBox="0 0 16 16">
  ...
  {
    name: 'settings',
    html: `<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
    ...
    e('div', {className: "split-content"}, [
      e('div', {id: 'split-0', className: "context_panel"}, [
        e('div', {className: "context_buttons"}, [
          ...contextButtons.map(b => e('div', {innerHTML: b.html})),
          e('div', {style: "flex-grow: 1;"}),
          ...bottomContextButtons.map(b => e('div', {innerHTML: b.html})),
