...
module.exports = () => {
  ...
  let str = #./some_data.cvs as is // as is simply return a string

  let data = #(./some_data.cvs) // check extension to import
  let data = #(./some_data.cvs as is) // no formatting, directly a string

  let img = #(./some_image.png)
  // Ah! Inside config.jome, for formats, allow them to handle file input like this
