module.exports = () => {
  ...
  <div id="left-nav" class="scrollable">
    <ul class="nav-list">
      ...
      <li><a href="${ROOT}/templates">Templates and Examples</a></li>
      <ul class="nav-list nav-sub">
        <li><a href="${ROOT}/templates/TODO">Basic (TODO: Hello world)</a></li>
        ...
        <li><a href="${ROOT}/templates/TODO">2d game (TODO: Snake)</a></li>
      ...
      <li><a href="${ROOT}/lib">In depth</a></li>
      <ul class="nav-list nav-sub">
