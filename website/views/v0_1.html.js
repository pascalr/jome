...
module.exports = () => {
  ...
  \`\`\`sh
  # FIXME: Should the package be installed globally or not? Globally does not lock in package.json?
  ...
  The syntax is permissive. For statement blocks, you can use either curly braces as a delimiter or use the \`end\` keyword.
  You can also use a combination of both. One thing which can be nice is to alternate between the two at every nesting level.
