...
module.exports = () => {
  ...
  *#
  ...
  This depends on other people.

  If the user somehow become popular, then operators are just the same as the flavor. This way it is easy when
  you read someone else code what it does because the operators are standard.

  If the language stays niche, then operators could be defined using the processing instruction \`<?op ?>\`.
