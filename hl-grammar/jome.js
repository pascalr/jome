...
const highlighter = function(hljs) {
  ...
  const KEYWORD = {
    scope: "keyword",
    begin: '\\b(init|attr|parent|exe|end|if|si|class|export|import|from|def|var|let|code|unit|false|true|null|return|module|interface|main|type|else|elif|elsif)\\b'
  }
